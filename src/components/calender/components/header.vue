<template>
  <div class="full-calendar-header">
    ...
    <div class="header-center">
      <el-button icon="el-icon-arrow-left" size="mini" circle @click.stop="goPrev"></el-button>
      <span class="title">{{title}}</span>
      <el-button icon="el-icon-arrow-right" size="mini" @click.stop="goNext" circle></el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    dispatchEvent () {
      ...
      this.$emit('change', dateFunc.format(startDate, 'yyyy-MM-dd'),
